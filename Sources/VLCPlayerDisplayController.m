...
- (void)_showHideMiniPlaybackView
{
    ...
    if (needsShow) {
        if (!miniPlaybackView) {
            ...
            self.miniPlaybackView = miniPlaybackView = [[VLCAudioMiniPlayer alloc]
                                                        initWithMedialibraryService:_services.medialibraryService
    ...
    [miniPlaybackView prepareForMediaPlayback:_playbackService];
